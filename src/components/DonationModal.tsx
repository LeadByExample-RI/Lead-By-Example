      ...
      <AnimatePresence>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1, y: 0 }}
            exit={{ opacity: 0, scale: 0.95, y: 20 }}
            className="w-full max-w-md rounded-2xl border border-white/20 bg-gradient-to-br from-[#4B306A]/95 to-[#421B5A]/95 p-6 shadow-2xl"
          >
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-xl font-bold text-white">Payment Unavailable</h2>
              <button
                onClick={onClose}
            ...
            <p className="text-white/70">
              Payment processing is currently unavailable. Please contact us directly to make a
              donation.
            </p>
          </motion.div>
        </div>
